"""
Django settings for burgercollector project.
...
SECRET_KEY = 'django-insecure-2h5!meg%&qg2sz*l366jbmwi*o_p$=*!uz8n6%(8@x2f(%sm#!'
...
ROOT_URLCONF = 'burgercollector.urls'
...
WSGI_APPLICATION = 'burgercollector.wsgi.application'
